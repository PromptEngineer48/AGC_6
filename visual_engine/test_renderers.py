...
async def test_remotion():
    ...
    try:
        ...
        cli_path = remotion_dir / "node_modules" / "@remotion" / "cli" / "remotion-cli.js"
        subprocess.run(
            ["node", str(cli_path.absolute()), "render", "src/index.ts", "HelloWorld", str(out_path.absolute()), "--props", props_str],
